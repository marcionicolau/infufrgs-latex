...
\mode<presentation>{\usetheme{Inf}}
\usepackage{chemformula}
\usepackage[utf8]{inputenc}
\usepackage[brazilian, english]{babel} % required for rendering German special characters
...
\title{\huge Neurosymbolic Computer Vision: A New Paradigm for AI}
\author{Marcio Nicolau$^{1,2}$, Claudio Jung$^{1}$, Luis Lamb$^{1}$}
\institute[UFRGS]{$^{1}$Institute of Informatics, Federal University of Rio Grande do Sul, Brazil \\ $^{2}$Embrapa Wheat, The Brazilian Agricultural Research Corporation, Brazil}
\date{\today}
